...
public class XMLExport {
	...
	public String getXML() {
		...
		for (Language language : Language.getAllLanguages().values()) {
			...
			for (Event event : events) {
				...
				xml += new XMLExportEntry(event, language, translation,
						dateChanged, highlighted.contains(event.getKey()), true)
						.getXML();
	 ...
	 * 
	 * @return The XML tag tree for all requested images, plus an "individual"
	 *         item for manual editing.
	 */
