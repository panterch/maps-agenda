...
public class Translators implements java.io.Serializable {
  ...
  /** 
   * Returns the Translators object. It contains all the translators defined in the application.
   */
   ...
   * 
   * @param packed string representation of a Translator in the database.
  ...
  private static Translator extractTranslator(String email, String packed) {
    ...
    return new Translator(email, fields[0], Arrays.asList(Arrays.copyOfRange(fields, 1, fields.length)));
  }
  
  /**
   * Packs the provided Translator into its database representation.
   * 
   * @param t the translators to pack in its database representation.
